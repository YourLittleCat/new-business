...
public class Order {
    ...
    public Order(Integer id, Long order_no, Integer user_id, Integer shipping_id, BigDecimal payment, Integer payment_type, Integer postage, Integer status, Date payment_time, Date send_time, Date end_time, Date close_time, Date creat_time, Date update_time) {
        this.id = id;
        this.order_no = order_no;
        this.user_id = user_id;
        this.shipping_id = shipping_id;
