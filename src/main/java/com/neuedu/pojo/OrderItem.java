...
public class OrderItem {
    ...
    public OrderItem(Integer id, Integer user_id, Long order_no, Integer product_id, String product_name, String product_image, BigDecimal current_unit_price, Integer quantity, BigDecimal total_price, Date send_time, Date end_time, Date close_time, Date create_time, Date update_time) {
        this.id = id;
