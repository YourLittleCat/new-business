package com.neuedu.Dao.MybatisImpl;
...
public class UserDaoImp implements IUserDao{
  ...
  //      System.out.println("==============");
    ...
    //    System.out.println(map+"mybatisImp里面的UserDaoImp");
    //    System.out.println(sqlSession);
        UserInfo user=  sqlSession.selectOne("com.neuedu.Dao.IUserDao.getUser",map );
   //   System.out.println("mybatis里面的user"+user);
